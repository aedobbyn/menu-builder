...
The naive approach of mapping character over all the nutrients columns doesn't give us what we want (which I feel is somewhat analagous to the sentiment in this [GitHub Issue](https://github.com/tidyverse/purrr/issues/265)):
