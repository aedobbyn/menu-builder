...
This is an ongoing project on food. It's mainly an excuse for me to use several data science techniques in various proportions: along the way I query an API, generate menus, solve them algorithmically, simulate solving them, scrape the web for real menus, and touch on some natural language processing techniques. Don't worry about getting too hungry: this project has been fairly nicknamed/slandered "Eat, Pray, Barf."
...
```{r do_simulate_swap_spectrum, message=FALSE}
...
```{r plot_status_spectrum_summary}
