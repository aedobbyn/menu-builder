...
```{r read_in_abbre}
abbrev <- readxl::read_excel("./data/raw/ABBREV.xlsx") %>% as_tibble()

abbrev %>% kable()
```

You can read in depth the prep I did on this file in `/scripts/prep`. Mainly this involved a bit of cleaning on the column names like stripping out parentheses. In there you'll also find 
